...
<body>
	...
	WifiInfo wifiInfo = DbInfo.wifiDetail(mgrNo);
	...
	<table class="wifi-table">
		<thead>
			...
			<tr>	
				<th>관리번호</th>
				<td><%=wifiInfo.getxSwifiMgrNo()%></td>
			</tr>
			<tr>	
				<th>자치구</th>
				<td><%=wifiInfo.getxSwifiWrdofc()%></td>
			</tr>
			<tr>	
				<th>와이파이명</th>
				<td><%=wifiInfo.getxSwifiMainNm()%></td>
			</tr>
			<tr>	
				<th>도로명주소</th>
				<td><%=wifiInfo.getxSwifiAdres1()%></td>
			</tr>
			<tr>	
				<th>상세주소</th>
				<td><%=wifiInfo.getxSwifiAdres2()%></td>
			</tr>
			<tr>	
				<th>설치위치(층)</th>
				<td><%=wifiInfo.getxSwifiInstlFloor()%></td>
			</tr>
			<tr>	
				<th>설치유형</th>
				<td><%=wifiInfo.getxSwifiInstlTy()%></td>
			</tr>
			<tr>
				<th>설치기관</th>
				<td><%=wifiInfo.getxSwifiInstlMby()%></td>
			</tr>
			<tr>	
				<th>서비스구분</th>
				<td><%=wifiInfo.getxSwifiSvcSe()%></td>
			</tr>
			<tr>	
				<th>망종류</th>
				<td><%=wifiInfo.getxSwifiCmcwr()%></td>
			</tr>
			<tr>	
				<th>설치년도</th>
				<td><%=wifiInfo.getxSwifiCnstcYear()%></td>
			<tr>	
				<th>실내외구분</th>
				<td><%=wifiInfo.getxSwifiInoutDoor()%></td>
			</tr>
			<tr>	
				<th>WIFI접속환경</th>
				<td><%=wifiInfo.getxSwifiRemars3()%></td>
			</tr>
			<tr>	
				<th>X좌표</th>
