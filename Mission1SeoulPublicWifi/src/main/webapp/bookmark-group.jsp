...
<body>
	...
	<div class="current">
		<a href="bookmark-group-add.jsp" class ="under-line"><button>북마크 그룹 이름 추가</button></a>
	</div>
	<table class="wifi-table">
		<thead>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td><a href="bookmark-group-edit.jsp" style="margin-right: 10px;">수정</a><a href="bookmark-group-delete.jsp">삭제</a></td>
			</tr>
		</thead>
	</table>
</body>
