...
public class WifiInfo {
	...
	private Timestamp groupRegist;
	private Timestamp editTime;
	
	private Timestamp bookmarkRegist;
	...
	public Integer getxSwifiCnstcYear() {
		return xSwifiCnstcYear;
	}
	public void setxSwifiCnstcYear(Integer xSwifiCnstcYear) {
	...
	public Timestamp getGroupRegist() {
		return groupRegist;
	}
	public void setGroupRegist(Timestamp groupRegist) {
		this.groupRegist = groupRegist;
	}
	...
	public Timestamp getBookmarkRegist() {
		return bookmarkRegist;
	}
	public void setBookmarkRegist(Timestamp bookmarkRegist) {
		this.bookmarkRegist = bookmarkRegist;
	}
